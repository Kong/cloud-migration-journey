...
**It is important to understand that for cross zone communication to be successful, mTLS needs to be enabled. Zone Egress requires mTLS, and is how cross zone communication is enforce.**
